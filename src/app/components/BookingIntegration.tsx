...
export default function BookingIntegration() {
  ...
  const loadVehicles = async () => {
    try {
      // For now, use static data until backend vehicles endpoint is ready
      const staticVehicles = [
        { id: '1', name: 'Luxury Sedan', type: 'sedan', price: 100 },
        { id: '2', name: 'Premium SUV', type: 'suv', price: 150 },
        { id: '3', name: 'Executive Van', type: 'van', price: 200 }
      ]
